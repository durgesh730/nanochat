...
const rows = [
     createData('PGIMER, Chandigarh', 2023, "Download"),
     createData('Government Medical College and Hospital', 2023, "Download"),
...
export default function Download() {
     return (
          <>
               ...
               <Typography sx={{ textAlign: "center", fontSize: "2rem", alignItems: "center", marginBottom: "2rem", marginTop: "5rem" }} >Chandigarh Medical Colleges List </Typography>
