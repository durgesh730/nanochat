    ...
    const CollegeInfo = [
        {
            ...
            infrastructure: {
                ...
                paraSecond: "There are some special features available.These are E-library, Lift & CCTV, Water Dispenser (First floor), Internet Services (Ethernet & Wi-Fi), Photocopying, Discussion & Smart Interaction Zone, Fire Alarm & Announcement system, Online Public Access Catalogue(OPAC), printing & binding services.",
            },
            hostel: {
                img: hostel,
